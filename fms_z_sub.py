...
def listener(sample: Sample):
    ...
    #      .format(sample.kind, sample.key_expr, sample.payload.decode("utf-8", errors='ignore')))
    # ParseFromString(sample.payload.decode("utf-8", errors='replace'))
          
    #print(">> [Subscriber] Received {})".format(sample.payload.decode("utf-8", errors='replace')))
    vehiclestatus = fms_pb2.VehicleStatus();
    vehiclestatus.ParseFromString(sample.payload)
    print(vehiclestatus)
